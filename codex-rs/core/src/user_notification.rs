...
mod tests {
    ...
    fn test_user_notification() -> Result<()> {
        ...
        assert_eq!(
            serialized,
            r#"{"type":"agent-turn-complete","session-id":"b5f6c1c2-1111-2222-3333-444455556666","turn-id":"12345","input-messages":["Rename `foo` to `bar` and update the callsites."],"last-assistant-message":"Rename complete and verified `cargo build` succeeds."}"#
        );
        Ok(())
    }
}
