...
impl SessionManager {
    ...
    pub async fn handle_exec_command_request(
        ...
        let (session, mut exit_rx) = create_exec_command_session(session_id, params.clone())
            .await
            .map_err(|err| {
                format!(
        ...
        // TODO(mbolin): Ensure max_output_tokens is honored correctly.
        let original_token_count = None;
